from use_cases.managerr.create_booking.create_booking_use_case import CreateBookingUseCase 
from repositories.booking_repository import BookingRepository
from repositories.customer_repository import CustomerRepository
from fastapi import FastAPI, Request, Response
from use_cases.managerr.create_booking.create_booking_dto import CreateBookingDTO
...
@router.post("/manager/create-booking-table")
