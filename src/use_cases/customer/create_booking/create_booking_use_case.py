...
from repositories.customer_repository import CustomerRepository  # Para buscar o cliente pelo e-mail
...
class CreateBookingUseCase:
    ...
    def execute(self, create_booking_dto: CreateBookingDTO, response: Response, request: Request):
        ...
        booking = Booking(
            ...
            customer_id=customer.id  # Conectando o cliente à reserva
        )

        self.booking_repository.save(booking)
        response.status_code = 201
        return {"status": "success", "message": f"Reserva criada com sucesso para o cliente {create_booking_dto.email}"}
