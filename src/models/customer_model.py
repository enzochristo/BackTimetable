...
class CustomersModel(Document):
    ...
    def get_normal_fields():
        return [i for i in CustomersModel.__dict__.keys() if i[:1] != '_' and i != "sensivity_fields" and i not in CustomersModel.sensivity_fields]
